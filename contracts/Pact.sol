...
/*
        ...
        string[] memory splitResults = new string[](commaCount+1);

        uint beginString = 0;
        uint stringIndex = 0;
        for (uint i=0; i < responseData.length; i++) {
            if(responseData[i] == ",") {
                splitResults[stringIndex] = bytes32ToString(responseData[beginString:i]);
                beginString = i+1;
                stringIndex++;
            }
            // last string
...
*/
/*
        string[] memory splitResults = new string[](5);
        splitResults[0] = "0";
        splitResults[1] = "1";
        splitResults[2] = "2";
        splitResults[3] = "3";
